  ...
  (0, _createClass3.default)(LoadBalancer, [{
    ...
    value: function _resolveSeedRouter(seedRouter) {
      ...
      var dnsResolutions = customResolution.then(function (resolvedAddresses) {
        return _promise2.default.all(resolvedAddresses.map(function (address) {
      ...
      return routerAddresses.reduce(function (refreshedTablePromise, currentRouter, currentIndex) {
        return refreshedTablePromise.then(function (newRoutingTable) {
          ...
          return _this8._createSessionForRediscovery(currentRouter).then(function (session) {
            if (session) {
              return _this8._rediscovery.lookupRoutingTableOnRouter(session, currentRouter);
            } else {
    ...
    value: function _updateRoutingTable(newRoutingTable) {
      ...
      staleServers.forEach(function (server) {
        return _this9._connectionPool.purge(server);
      });
...
var SingleConnectionProvider = exports.SingleConnectionProvider = function (_ConnectionProvider3) {
  ...
  function SingleConnectionProvider(connection) {
    ...
    var _this10 = (0, _possibleConstructorReturn3.default)(this, (SingleConnectionProvider.__proto__ || (0, _getPrototypeOf2.default)(SingleConnectionProvider)).call(this));

    _this10._connection = connection;
    return _this10;
  }
