...
var RoutingTable = function () {
  ...
  (0, _createClass3.default)(RoutingTable, [{
    ...
    value: function serversDiff(otherRoutingTable) {
      var oldServers = this._allServers();
      var newServers = otherRoutingTable._allServers();
      var diffTable = {};
      oldServers.forEach(function (oldServer) {
        return diffTable[oldServer.asKey()] = oldServer;
      });
      newServers.forEach(function (newServer) {
        return delete diffTable[newServer.asKey()];
      });
      return (0, _values2.default)(diffTable);
    }
