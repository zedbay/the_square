...
var _serverAddress = require('./internal/server-address');
...
function driver(url, authToken) {
  ...
  if (parsedUrl.scheme === 'bolt+routing') {
    return new _routingDriver2.default(_serverAddress2.default.fromUrl(parsedUrl.hostAndPort), parsedUrl.query, USER_AGENT, authToken, config);
    ...
    return new _driver.Driver(_serverAddress2.default.fromUrl(parsedUrl.hostAndPort), USER_AGENT, authToken, config);
