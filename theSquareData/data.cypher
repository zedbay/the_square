...
CREATE (Michael:Person { name: 'Scott', firstName: 'Michael', email: 'sm@gmail.com', password: 'a'})
CREATE (Dwight:Person { name: 'Schrute', firstName: 'Dwight', email: 'sd@gmail.com', password: 'a'})
CREATE (Jim:Person { name: 'Halpert', firstName: 'Jim', email: 'hj@gmail.com', password: 'a'})
CREATE (Pam:Person { name: 'Beesly', firstName: 'Pam', email: 'bp@gmail.com', password: 'a'})
CREATE (Ryan:Person { name: 'Howard', firstName: 'Ryan', email: 'hr@gmail.com', password: 'a'})
CREATE (Andy:Person { name: 'Bernard', firstName: 'Andy', email: 'ba@gmail.com', password: 'a'})
CREATE (Stanley:Person { name: 'Hudson', firstName: 'Stanley', email: 'hs@gmail.com', password: 'a'})
CREATE (Kevin:Person { name: 'Malone', firstName: 'Kevin', email: 'mk@gmail.com', password: 'a'})
CREATE (Angela:Person { name: 'Martin', firstName: 'Angela', email: 'ma@gmail.com', password: 'a'})
CREATE (Oscar:Person { name: 'Martinez', firstName: 'Oscar', email: 'mo@gmail.com', password: 'a'})
CREATE (Phyllis:Person { name: 'Lapin', firstName: 'Phyllis', email: 'lp@gmail.com', password: 'a'})
CREATE (Kelly:Person { name: 'Kapoor', firstName: 'Kelly', email: 'kk@gmail.com', password: 'a'})
CREATE (Creed:Person { name: 'Bratton', firstName: 'Creed', email: 'bc@gmail.com', password: 'a'})
CREATE (Toby:Person { name: 'Flenderson', firstName: 'Toby', email: 'ft@gmail.com', password: 'a'})
CREATE (Darryl:Person { name: 'Philbin', firstName: 'Darryl', email: 'pd@gmail.com', password: 'a'})
